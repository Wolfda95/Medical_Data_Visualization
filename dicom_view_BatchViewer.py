...
def visualisierung(patient_dicom, patient_pixels):
    print(patient_dicom[0]) # DICOM Header der ersten Schicht
    print("-------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print(
        "-------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print(
        "-------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print(patient_dicom[1])
    print("-------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print(
        "-------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print(
...
def run_ct_resize (path, body_part):
    ...
    resize = scipy.ndimage.zoom(patient_pixels, (min(1,(48 / patient_pixels.shape[0])), (256/patient_pixels.shape[1]), (256/patient_pixels.shape[2])), mode="grid-constant", grid_mode=True)
